...
if __name__ == "__main__":
    ...
    ## 2 players
    #print(evaluate_player(100, [2.0, 4.0, 15.0, 25.0, 24.0, 17.0, 19.0, 0.0, 13.0, 9.0, 14.0, 28.0, 11.0, 22.0, 23.0, 1.0, 16.0, 5.0, 6.0, 
    #        18.0, 3.0, 20.0, 8.0, 12.0, 7.0, 21.0, 10.0, 27.0, 26.0], "mirror"))
    ## 3 players
